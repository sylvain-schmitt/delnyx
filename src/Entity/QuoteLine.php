...
#[ApiResource(
    ...
    normalizationContext: ['groups' => ['quote_line:read']],
    denormalizationContext: ['groups' => ['quote_line:write']]
)]
class QuoteLine
{
    #[ORM\Id]
    ...
    public function setQuote(?Quote $quote): static
    {
        ...
        // Si le quote a un taux de TVA, l'appliquer à la ligne si non défini
        if ($quote && $quote->getTauxTVA() && !$this->tvaRate) {
            $this->tvaRate = $quote->getTauxTVA();
        }
