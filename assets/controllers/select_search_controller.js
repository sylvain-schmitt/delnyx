...
export default class extends Controller {
    connect() {
        ...
        // Si le select est désactivé, désactiver aussi l'input de recherche
        if (select.disabled) {
        ...
        if (fieldType === 'quote') {
            ...
            if (selectName.includes('[quote]') || selectName.includes('quote') || selectId.includes('quote') ||
                ...
                placeholder = 'Rechercher un devis...'
            } else if (selectName.includes('[invoice]') || selectName.includes('invoice') || selectId.includes('invoice') ||
                labelText.toLowerCase().includes('facture')) {
                placeholder = 'Rechercher une facture...'
